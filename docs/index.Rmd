...
The chart is included to indicate the underlying issue of climate change.

From the early *1950s* until recently, we can clearly see a major upward trend in number of disasters. Especially in floods. This might indicate the fact that there are some major factors that are affecting our climate.
...
The plot is included to demonstrates the trend of land temperature in the last 60 years.

As can be seen in the chart, in the last 50 years, the average land temperature has been steadily increasing almost linearly. This demonstrates the presence of global warming. Also, this can be used to explain the cause of major uptrend in floods recently. 
